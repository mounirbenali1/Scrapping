...
class HashtagSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ACCESS_TOKEN="2227252502-ZPghDcVVpZJlTudaBi0dXzjyLaLnV5LC4Aa5yEP"
        ACCESS_TOKEN_SECRET="ACNWwmzGrmtMOj02jkQHn5IUnBne6nKatE5d70VXDYLOc"
        CONSUMER_KEY="faHeCoGZEZToto5hEIT8P3wmh"
        CONSUMER_SECRET="Yf2SSSgGFD1J1ATtipQ9uAGH1e6pUZYCJWJ2Nr8E6CdZSgHPlW"
        ...
        trends_name=[]
        trends_url=[]
        trends_loc=api.trends_place(UK_id)
        for a in trends_loc :
             for b in a["trends"]:
                trends_name.append(b["name"])
                trends_url.append(b["url"])
        ...
        #for hashtag in hashtags:
                if b["name"]:
                    search_url = "https://mobile.twitter.com/hashtag/GeorgeFloydMurder"
                    #+ b["name"].lower()
    ...
    def parse_tweet(self, response):
        ...
        result = {
            ...
            'no_of_retweets': int(retweets),
            'no_of_replies': int(replies),
